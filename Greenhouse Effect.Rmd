...
### Disclaimer
This blog post was from a written exercise from my previous job application. This post aims to demonstrate data manipulation, analysis, and visualisation using the R programming language as the underlying data is considered outdated.  
